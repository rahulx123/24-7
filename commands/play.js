    ...
    run: async function (client, message, args) {
        ...
        if (serverQueue) {
            ...
            let thing = new MessageEmbed()
                .setAuthor("Song has been added to queue", "https://www.youtube.com/channel/UC2P8KBTixZMVojWVX31ZRzA")
        ...
        const play = async (song) => {
            ...
            if (!song) {
                sendError(
                    "Thank you for using Nightrow Hosting! [Gilasa Youtube](https://www.youtube.com/channel/UC2P8KBTixZMVojWVX31ZRzA)",
                    message.channel
                );
            ...
            let thing = new MessageEmbed()
                .setAuthor("Started Playing Music!", "https://www.youtube.com/channel/UC2P8KBTixZMVojWVX31ZRzA")
                .setThumbnail(song.img)
                .setColor("#fffdd0")
                .addField("Name", song.title, true)
                .addField("Duration", song.duration, true)
